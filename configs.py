...
class Config(object):
    ...
    BOT_TOKEN = os.getenv("BOT_TOKEN", "6140911017:AAHDZGYsWlc3K8vvqAFnOclfGq9d2Snkkjg")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "MdiskSearchRoyalBot")
    ...
    BOT_USERNAME = os.getenv("BOT_USERNAME", "MdiskSearchRoyalBot")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001426332370")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://Arnav898:Arnav898@cluster0.t668vzw.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001634563825"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "RoyalbotsMovie")
